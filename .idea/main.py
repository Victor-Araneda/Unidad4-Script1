...
"""
Este script busca entregar informaciòn de IP de todos los equipos de
la red programable
"""
import sys
import re
...
def main():
    ...
    description = 'Este script busca entregar informaciòn de IP de todos los equipos de la red programable'
